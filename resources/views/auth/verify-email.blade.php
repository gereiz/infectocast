            ...
            <div class="lg:col-span-5 flex items-center">
                <div class="!px-12 !py-12 card-body">
                    ...
                    <div class="text-center">
                        <h4 class="mb-2 text-purple-500 dark:text-purple-500">Verificação de Email !</h4>
                        <p class="text-slate-500 dark:text-zink-200">Se você não tiver recebido o email de verificação, clique em no botão abaixo...</p>
                    </div>
                    ...
                    <div class="mt-10">
                        <form method="POST" action="{{ route('verification.send') }}">
                            ...
                            <div class="text-center">
                                <button type="submit"
                                    class="w-full text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">{{ __('Enviar e-mail de verifiação') }}</button>
                            </div>
                        </form>
