...
@section('content')
    ...
    <x-page-title title="Lista de Pagamentos" pagetitle="pagamentos" />
                ...
                <div>
                    <div class="relative xl:w-3/6">
                        <input type="text"
                            ...
                            placeholder="Pesquisar Política ..." autocomplete="off">
                        <i data-lucide="search"
                            class="inline-block size-4 absolute ltr:left-2.5 rtl:right-2.5 top-2.5 text-slate-500 dark:text-zink-200 fill-slate-100 dark:fill-zink-600"></i>
                    </div>
                </div>
                <div class="ltr:md:text-end rtl:md:text-start">
                    <a type="button" href="#" class="btn-add">
                        ...
                        @foreach ($payments as $payment)
                            <tr>
                                ...
                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 email">
                                    <p>{{$payment->order_status}}</p>
                                </td>

                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 email">
                                    <p>{{$payment->order_value}}</p>
                                </td>
                                ...
                                <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                    <div class="flex gap-2">
                                        ...
                                        <div class="remove">
                                            <button data-modal-target="{{'deleteModal/'.$payment->id}}" id="delete-record" class="py-1 text-xs text-white bg-red-500 border-red-500 btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100 dark:ring-custom-400/20 remove-item-btn">
                                                Excluir
                                            </button>
                                        </div>
                                    </div>
                            ...
                            {{-- Modal Delete --}}
                            {{-- <div id={{'deleteModal/'.$payment->id}} modal-center
                                    ...
                                    <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto px-6 py-8">
                                        <form method="POST" action="{{urL('deletePlan')}}">
                                            ...
                                            <div class="mb-3" id="modal-id" style="display: none;">
                                                <label for="id_payment" class="inline-block mb-2 text-base font-medium">ID</label>
                                                <input type="text" id="id_payment" name="id_payment" value="{{$payment->id}}"
                                                    class="input-text"
                                                    placeholder="ID" readonly="">
                                            </div>
                                            <div class="float-right">
                                                <button data-modal-close={{'deleteModal/'.$payment->id}} id="close-removeNotesModal"
                                            ...
                                            <div class="mt-5 text-center">
                                                ...
                                                <div class="flex justify-center gap-2 mt-6">
                                                    <button type="button" data-modal-close={{'deleteModal/'.$payment->id}}
